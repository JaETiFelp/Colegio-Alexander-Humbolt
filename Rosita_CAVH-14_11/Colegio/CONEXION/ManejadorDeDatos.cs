    ...
    public class ManejadorDeDatos
    {
        ...
        public ManejadorDeDatos()
        {
           ...
           // cnx = new SqlConnection("Data Source=ELIOD-PC;Initial Catalog=CAVH;Integrated Security=True");
            ...
            cnx = new SqlConnection("Data Source=ELIOD-PC;Initial Catalog=CAVH3;Integrated Security=True");
        ...
        {
            SqlConnection Conn = new SqlConnection("Data Source=ELIOD-PC;Initial Catalog=CAVH3;Integrated Security=True");
            Conn.Open();
        ...
        public String obtennerCaminoConexion()
        {
            ...
            string cadeni = "Data Source=ELIOD-PC;Initial Catalog=CAVH3;Integrated Security=True";
            return cadeni;
